...
*/
trigger OpportunityTrigger on Opportunity (before update, after update, before insert, after insert, after delete, before delete) {
    ...
    */
    if (Trigger.isUpdate && Trigger.isBefore){
        OpportunityTriggerHandler.oppAmountLimit(Trigger.new);
    }
/*
    * Opportunity Trigger
...
*/
    if (Trigger.isDelete){
        OpportunityTriggerHandler.preventOppDelete(Trigger.old);
    }
